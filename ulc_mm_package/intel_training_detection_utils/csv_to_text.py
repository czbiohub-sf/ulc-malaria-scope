...
def convert_csv_to_txt(csv_path, images, label_ids, width, height, input_image_format):
    ...
    for img_name in images:
        ...
        text_path = os.path.join(dirname, basename.replace(input_image_format, ".txt"))
...
def main():
    ...
    convert_csv_to_txt(val_csv_path, val_images, label_ids, width, height, image_format)
