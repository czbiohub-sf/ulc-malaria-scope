...
def make_html_report(
    ...
    comp_perc_parasitemia_err: str,
    raw_parasites_per_ul: str,
    comp_parasites_per_ul: str,
    comp_parasites_per_ul_err: str,
    ...
    context = {
        ...
        "comp_perc_parasitemia_err": comp_perc_parasitemia_err,
        "raw_parasites_per_ul": raw_parasites_per_ul,
        "comp_parasites_per_ul": comp_parasites_per_ul,
        "comp_parasites_per_ul_err": comp_parasites_per_ul_err,
