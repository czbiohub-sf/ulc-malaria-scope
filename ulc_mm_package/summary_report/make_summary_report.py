...
def make_html_report(
    ...
    perc_parasitemia_err: str,
    parasites_per_ul: str,
    parasites_per_ul_err: str,
    ...
    context = {
        ...
        "raw_perc_parasitemia": perc_parasitemia,
        "comp_perc_parasitemia": perc_parasitemia,
        "comp_perc_parasitemia_err": perc_parasitemia_err,
        "raw_parasites_per_ul": parasites_per_ul,
        "comp_parasites_per_ul": parasites_per_ul,
        "comp_parasites_per_ul_err": parasites_per_ul_err,
