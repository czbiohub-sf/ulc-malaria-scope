    ...
    def close(
        ...
        if pred_tensors is not None and pred_tensors.size > 0:
            ...
            html_report_with_abs_path = make_html_report(
                ...
                class_name_to_cell_count,
                f"{raw_perc_parasitemia:.2e}",
                f"{comp_perc_parasitemia:.2e}",
                f"{comp_perc_parasitemia_err:.2e}",
                f"{RBCS_PER_UL*raw_perc_parasitemia:.2e}",
                f"{RBCS_PER_UL*comp_perc_parasitemia:.2e}",
                f"{RBCS_PER_UL*comp_perc_parasitemia_err:.2e}",
