    ...
    def __init__(
        ...
        ---------------------------
            ...
            while im in camera.yieldImages():
                dx, dy, xcorr_coeff = fre.add_image_and_calculate_pair_displacement()

                if fre.is_primed():
                    # Do something with dx, dy, xcorr_coeff
                    (since the estimator needs to receive at least two images before it can return a meaningful value)
