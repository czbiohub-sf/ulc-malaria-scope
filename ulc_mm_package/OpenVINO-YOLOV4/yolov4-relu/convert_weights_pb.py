...
tf.app.flags.DEFINE_string(
    ...
    "Frozen tensorflow protobuf model output path",
)

tf.app.flags.DEFINE_bool("tiny", False, "Use tiny version of YOLOv4")
...
def main(argv=None):
    ...
    with tf.variable_scope("detector"):
        ...
        load_ops = load_weights(
            tf.global_variables(scope="detector"), FLAGS.weights_file
        )
