...
CLINICAL_PARASITE_SITES = ["Tororo, Uganda", "Masafu, Uganda"]
CULTURED_PARASITE_SITES = ["Biohub SF", "DeRisi Lab", "Filipa Lab"]
SITE_LIST = CLINICAL_PARASITE_SITES + CULTURED_PARASITE_SITES
