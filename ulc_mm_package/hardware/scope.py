...
from ulc_mm_package.scope_constants import SIMULATION, CAMERA_SELECTION, CameraOptions, DOWNSAMPLE_FACTOR
...
class MalariaScope:
    ...
    def reset_for_end_experiment(self) -> None:
        ...
        self.autofocus_model.restart()
        self.cell_diagnosis_model.restart()
