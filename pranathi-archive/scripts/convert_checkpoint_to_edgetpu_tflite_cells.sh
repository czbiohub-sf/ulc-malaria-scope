...
source "$PWD/constants_cells.sh"

mkdir -p "${OUTPUT_DIR}"

echo "GENERATING label file..."
echo "0 healthy" >> "${OUTPUT_DIR}/labels.txt"
echo "1 ring" >> "${OUTPUT_DIR}/labels.txt"
echo "2 schizont" >> "${OUTPUT_DIR}/labels.txt"
echo "3 troph" >> "${OUTPUT_DIR}/labels.txt"
