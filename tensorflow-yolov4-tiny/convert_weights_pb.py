...
tf.app.flags.DEFINE_string(
    'class_names', 'obj.names', 'File with class names')
tf.app.flags.DEFINE_string(
    'weights_file', 'yolov4-tiny-obj_best.weights', 'Binary file with detector weights')
tf.app.flags.DEFINE_string(
    'data_format', 'NHWC', 'Data format: NCHW (gpu only) / NHWC')
tf.app.flags.DEFINE_string(
    'output_graph', 'yolov4-tiny-obj_best.pb', 'Frozen tensorflow protobuf model output path')
