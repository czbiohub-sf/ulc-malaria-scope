...
if __name__ == '__main__':
    ...
    inference_times = []
    parsing_times = []
    while cap_condition or index_images >= 0:
        ...
        if key == 27:
            break
    print("inference_time average is {} and {}". format(np.mean(inference_times), np.std(inference_times)))
    print("parsing_time average is {} and {}". format(np.mean(parsing_times), np.std(parsing_times)))
